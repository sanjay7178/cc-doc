...
You can run this documentation side inside a [Docker](https://docs.docker.com/)
...
1. Verify that the service is working.
   ...
   This opens a local instance of the ClusterCockpit homepage. You can now make
   changes to the content and those changes will immediately show up in your
